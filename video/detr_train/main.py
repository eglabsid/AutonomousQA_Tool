...
import os
root = f'{os.getcwd()}/video/detr_train/'

image = read_image(root+"data/PennFudanPed/PNGImages/FudanPed00046.png")
mask = read_image(root+"data/PennFudanPed/PedMasks/FudanPed00046_mask.png")
